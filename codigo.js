...
function obtenerProductos() {
 fetch('https://retoolapi.dev/ibnMVL/productos')
	   .then(res=>res.json())
...
var miProducto = {image:imagen,price:precio,title:titulo,description:descripcion,category:categoria};
...
fetch('https://retoolapi.dev/ibnMVL/productos/'+fila,{method:"DELETE"}).then(response=>response.json()).then(data=>delresult=data);
obtenerProductos();
}